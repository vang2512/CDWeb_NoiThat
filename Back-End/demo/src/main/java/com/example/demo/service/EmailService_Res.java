...
public class EmailService_Res {
    ...
    public void sendOtpEmail(String recipient, String otp) {
        ...
        try {
            ...
            message.setSubject("BAYA - Mã OTP xác thực đặt lại mật khẩu");
            ...
            String htmlContent =
                    "<!DOCTYPE html>" +
                            ...
                            // TITLE
                            "<tr><td>" +
                            "<h3 style='margin:10px 0;color:#333'Đặt lại mật khẩu</h3>" +
                            "<p style='color:#777;font-size:14px'>Sử dụng mã OTP bên dưới để hoàn tất đặt mật khẩu mới</p>" +
                            "</td></tr>" +
